...
CPUEdat<-read.csv(file=paste(getwd(),"/data/ICCAT_2022_1/CPUE_indices compiled_OM_9Mar2022.csv",sep=""))[,1:9] # !TSD Table 2.1
Iobs<-read.csv(paste(getwd(),"/data/ICCAT_2022_1/FI_indices_compiled_OM_9Mar2022_wNA.csv",sep=""))
