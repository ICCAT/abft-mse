...
# (2) Fitting of various natural-mortality rate and maturity rate scenarios (I, II and III)
...
for(i in 1:3){
  ...
  M3write(OMI,datfile=paste(OMfolder,"/M3.dat",sep=""))              # write the appropriate data file into the temporary folder ready to be run in parallel
