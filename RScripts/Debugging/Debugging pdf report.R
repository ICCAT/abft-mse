...
load("Objects/Bad_Obs")

make_fit_reports(dirs="E:/ABT-MSE/M3")
make_fit_reports(dirs=paste("E:/ABT-MSE/Objects/Reference OMs/",1:24,sep=""))

Perr[,y]<-AC*Perr[,y-1]+Perr[,y]*(1-AC*AC)^0.5#2#
