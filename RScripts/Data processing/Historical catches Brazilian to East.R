...
cond= dat$Year>(1950-Base@Hyears[1]+1) & dat$Year<(1965-Base@Hyears[1]+1) & dat$Lat<20 & dat$Lon<25
dat$Area[cond]<-4
...
areasE<-match(c("NATL","EATL","SATL","MED"),Base@areanams) # 45deg longitude split
...
areasW<-match(c("GOM","WATL","GSL"),Base@areanams) # 45deg longitude split
