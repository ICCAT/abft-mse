...
#' \item{t0}{von Bertalanffy growth curve}
#' \item{Linf}{von Bertalanffy growth curve}
#' \item{Lvar_a}{length at age CV a parameter, CV = b + a * Len_age}
#' \item{Lvar_b}{length at age CV b parameter, CV = b + a * Len_age}
...
setClass("OMI",representation(
  ...
  t0='numeric',Linf='numeric',
  Lvar_a='numeric',Lvar_b='numeric',
...
#' \item{lnHR1}{a vector nstock long of historical recruitment deviation (log) for years prior to the initial year-10}
#' \item{lnHR2}{a vector nstock long of historical recruitment deviation (log) for years after to the initial year-10}
