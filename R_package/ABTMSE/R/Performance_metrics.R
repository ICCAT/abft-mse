...
#' Yield over the first 10 projected years (a performance metrics function of class PM)
#'
...
#' Yield over projected years 11-20 (a performance metrics function of class PM)
#'
#' @param MSE An object of class MSE
#' @return a matrix with n Management procedures (MSE@nMP) and nsim (MSE@nsim) columns from \code{MSE}
#' @examples
...
#' Yield over projected years 21-30 (a performance metrics function of class PM)
#'
#' @param MSE An object of class MSE
#' @return a matrix with n Management procedures (MSE@nMP) and nsim (MSE@nsim) columns from \code{MSE}
#' @examples
...
#' Probability of being in the Green Kobe region (F<FMSY AND B>BMSY) over all projected years (a performance metrics function of class PM)
#'
#' @param MSE An object of class MSE
#' @return a matrix with n Management procedures (MSE@nMP) and nsim (MSE@nsim) columns from \code{MSE}
#' @examples
...
#' Probability of Over-Fishing (F>FMSY) over all projected years (a performance metrics function of class PM)
#'
#' @param MSE An object of class MSE
#' @return a matrix with n Management procedures (MSE@nMP) and nsim (MSE@nsim) columns from \code{MSE}
#' @examples
...
#' Probability of Over-Fished status (B<BMSY) over all projected years (a performance metrics function of class PM)
#'
#' @param MSE An object of class MSE
#' @return a matrix with n Management procedures (MSE@nMP) and nsim (MSE@nsim) columns from \code{MSE}
#' @examples
...
AAVY<-function(MSE,pp=1){
  ...
  C<-MSE@C[,,pp,]
  C[C==0]<-tiny
  apply(((C[,,ind]-C[,,ind1])^2)^0.5/C[,,ind1],1:2,mean,na.rm=T)
}
class(AAVY)<-"PM"
