...
As you can see the observation error model is quite lengthy, an in particular the slot *MPind*.
...
plot(Y30arr[2,],D30arr[2,],xlab="Median yield",ylab="Median depletion",col="#0000ff95",pch=19) # plot of individual simulations
```
...
All MPs however have the same basic structure: they operate on a simulation number *x* of a simulated dataset object *dset* and return a single TAC recommendation. 
