...
### Tracking of 'master' abundance indices (for generatingstandardized effort, partial Fs) ###
...
Figure 2. 'Master index' tracking (implied fit): grey line is index, the purple line is both stocks combined. 
...
Figure 3.Regional comparisons (45deg W) with 2014 stock assessment.

### Stock-recruitment relationships (by East/West stock)

```{r Stock-recruitment, fig.width=5.5, fig.height=2.5,echo=FALSE}

 opt<-SRopt(out,plot=T,quiet=F,years=c(-Inf,Inf),type="BH",SSB0=out$SSB0)
...
```{r catchaggfit, fig.width=7, fig.height=9,echo=FALSE}
...
```{r fit to agg length observations, fig.width=7, fig.height=9,echo=FALSE}
...
Figure 9.Length composition residuals. Red points are negative Pearson residuals (predicted is higher than observed), blue circles are positive (predicted is lower than observed)
