...
if(!require('knitr'))install.packages('knitr',repos='http://cran.stat.sfu.ca')
if(!require('mvtnorm'))install.packages('mvtnorm',repos='http://cran.stat.sfu.ca')
if(!require('ggplot2'))install.packages('ggplot2',repos='http://cran.stat.sfu.ca')
...
# // libraries for getting VPAs / XSA up and running
#library(FLCore)
#library(FLAssess)
#library(FLXSA)
...
cat("Loading OM functions")
cat("\n")
source("Source/OM functions.r")
